    ...
    >
      <SimpleGrid columns={[1, null, 2]} spacing={10}>
        ...
        <Box marginTop="70px" marginBottom="50px">
          <Heading
            fontSize={
              variant && variant in headingSizes
                ? headingSizes[variant as keyof typeof headingSizes]
                : headingSizes["base"]
            }
          >
          ...
          <Text
            ...
            fontSize={
              variant && variant in textSizes
                ? textSizes[variant as keyof typeof textSizes]
                : textSizes["base"]
            }
            mb="30px"
            w="full"
